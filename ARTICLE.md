...
This article provides you resources in the form of cloud patterns to help Enterprise developers get started quickly on the different capabilities of IBM Cloud. 
