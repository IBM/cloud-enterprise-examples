...
Description: How does Event Streaming work & how to leverage it
Keywords: 'ibm cloud'
---
...
Event Streaming enables IBM Log Analysis to produce content to a message bus queue and Topic. IBM Log Analysis streaming helps you to connect third party consumers of topics to ingest into dashboards for visualization of event log data. 

Third party horizonal technologies such as Splunk, used in organizations for application management, security and compliance are able to leverage IBM Cloud Log Analysis with Event Streaming.

The content in this pattern, we will walk through setting up a sample event stream by utilizing IBM Cloud Event Streams and Event Streaming, to produce events to a topic for a simple consumer application to ingest.
...
<AnchorLinks bold>
  ...
  <AnchorLink>Configure Event Streaming</AnchorLink><br/>
  <AnchorLink>Start Event Streaming to Consumer</AnchorLink><br/>
</AnchorLinks>
<p>&nbsp;</p>

## Create IBM Event Streams Instance

You can use an existing IBM Log Analysis instance from your existing IBM enterprise cloud account or create a new one, you can refer [Provisioning an Instance](https://cloud.ibm.com/docs/log-analysis?topic=log-analysis-provision) to do so.

For the demo, an IBM Cloud Event Streams instance is required. Log into IBM Cloud > services and create your Event Streams instance, refer [Provision Event Streams Instance](https://cloud.ibm.com/docs/EventStreams?topic=EventStreams-connecting#provision_instance)
...
![Service Credential](./images/Logstreamsplunk_service_cred.png)
...
![Topic](./images/LogStreamSplunkTopic.png)
![Topic](./images/TopicPartition.png)
![Topic](./images/TopicMessageRetention.png)
...
If your Event Streaming has been whitelisted, you should see a screen similar to the one shown below. 

![Log Streaming](./images/eventstreams2.png)

** To configure Event Streaming, follow the instructions below:**
...
## Start Event Streaming to Consumer

Let's go a head and start Event Streaming, you may see a notice from Event Streaming asking if you've received the sample messages similar to the screen shown below, click yes.
...
Event streaming **Streaming** is active, similar to the screen shown below. 

![Consumer Recevied Event Streams](./images/consumer_logdna_activity.png)

<InlineNotification>

**The Consumer is now consuming an event log topic, that Event Streaming is sending to the IBM Cloud Event Streams message bus**. 
