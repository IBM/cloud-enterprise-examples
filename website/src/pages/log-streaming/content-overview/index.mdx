...
Log Streaming enables IBM Log Analysis to produce content to a message bus queue and Topic. IBM Log Analysis streaming helps you to connect third party consumers of topics to ingest into dashboards for visualization of event log data. 
...
<AnchorLinks bold>
  <AnchorLink>Create IBM Log Streams Instance</AnchorLink><br/>
  <AnchorLink>Setup Log Streams Demo</AnchorLink><br/>
  <AnchorLink>Configure Log Streaming</AnchorLink><br/>
  <AnchorLink>Start Log Streaming to Consumer</AnchorLink><br/>
</AnchorLinks>
<p>&nbsp;</p>

## Create IBM Log Streams Instance
...
Once your IBM Log Stream instance is setup, create a **Service Credential** account and then expand it to show the username, password (apikey) and kafka_brokers_sasl, similar to the screen shown below.
