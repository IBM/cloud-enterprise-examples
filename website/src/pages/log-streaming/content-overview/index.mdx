...
You can use an existing IBM Log Analysis instance or create a new one, refer [Provisioning an Instance](https://cloud.ibm.com/docs/Activity-Tracker-with-LogDNA?topic=Activity-Tracker-with-LogDNA-provision)
