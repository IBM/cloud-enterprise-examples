...
In this document, We will show you how to stream log events from IBM Log Analysis and IBM Cloud Activity Tracker to [Splunk](https://www.splunk.com/). In order to achieve this, we will use the below two capabilities:
...
On the IBM Log Analysis Dashboard, navigate to the gear icon (settings) > Streaming to enter the credentials gathered in the previous step as follows:
